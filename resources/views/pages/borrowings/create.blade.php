                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="borrow_date" name="borrow_date" max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" value="{{ old('borrow_date', date('Y-m-d')) }}" required oninvalid="this.setCustomValidity('Tanggal peminjaman wajib diisi!')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
