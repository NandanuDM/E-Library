    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table table id="membersTable" class="table table-bordered table-striped dataTable dtr-inline">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        var show = "<a href=\"/members/" + row.id + "\" class=\"btn btn-info btn-sm\"> Detail </a>";
                        var edit = "<a href = \"/members/" + row.id + "/edit\" class = \"btn btn-warning btn-sm\" > Edit </a>";
