                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Masukkan judul buku" value="{{ old('title') }}" required maxlength="255" oninvalid="this.setCustomValidity('Judul wajib diisi!')" oninput="setCustomValidity('')">
                                    @if ($errors->has('title'))
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="author" name="author" placeholder="Masukkan nama pengarang" value="{{ old('author') }}" required onkeypress="return isLetter(event)" maxlength="255" oninvalid="this.setCustomValidity('Pengarang wajib diisi!')" oninput="setCustomValidity('')">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="isbn" name="isbn" placeholder="Masukkan ISBN" value="{{ old('isbn') }}" required onkeypress="return isIsbn(event)" oninvalid="this.setCustomValidity('ISBN wajib diisi!')" oninput="setCustomValidity('')" maxlength="20">
                                    @if ($errors->has('isbn'))
                                    <div class="text-danger">
                                        {{ $errors->first('isbn') }}
                                    </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="publishedYear" name="published_year" placeholder="Masukkan tahun terbit" value="{{ old('published_year') }}" required onkeypress="return isNumber(event)" oninvalid="this.setCustomValidity('Tahun terbit wajib diisi!')" oninput="setCustomValidity('')">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="categoryId" name="category_id" required oninvalid="this.setCustomValidity('Kategori wajib dipilih!')" oninput="setCustomValidity('')">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="publisherId" name="publisher_id" required oninvalid="this.setCustomValidity('Penerbit wajib dipilih!')" oninput="setCustomValidity('')">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="language" name="language" required oninvalid="this.setCustomValidity('Bahasa wajib dipilih!')" oninput="setCustomValidity('')">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="stock" name="stock" placeholder="Masukkan jumlah stok" value="{{ old('stock') }}" required onkeypress="return isNumber(event)" oninvalid="this.setCustomValidity('Stok wajib diisi!')" oninput="setCustomValidity('')">
                                    @if ($errors->has('stock'))
                                    <div class="text-danger">
                                        {{ $errors->first('stock') }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="coverImage" name="cover_image" accept=".png" required oninvalid="this.setCustomValidity('Gambar sampul wajib diunggah!')" oninput="setCustomValidity('')">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="rentalPrice" name="rental_price" placeholder="Masukkan harga sewa" value="{{ old('rental_price') }}" required onkeypress="return isNumber(event)" oninvalid="this.setCustomValidity('Harga sewa wajib diisi!')" oninput="setCustomValidity('')">
