                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="isbn" name="isbn" value="{{ old('isbn', $book->isbn) }}" placeholder="Masukkan ISBN">
                                    @if ($errors->has('isbn'))
                                        <div class="text-danger">
                                            {{ $errors->first('isbn') }}
                                        </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="publishedYear" name="published_year" value="{{ old('published_year', $book->published_year) }}" placeholder="Masukkan tahun terbit" required>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="language" name="language" required>
                                        ...
                                        <option value="perancis" {{ old('language', $book->language) == 'perancis' ? 'selected' : '' }}>Perancis</option>
                                        <option value="lain-lain" {{ old('language', $book->language) == 'lain-lain' ? 'selected' : '' }}>Lain-lain</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="coverImage" name="cover_image" accept=".png">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="rentalPrice" name="rental_price" value="{{ old('rental_price', $book->rental_price) }}" required>
                            ...
                            <div class="col-12">
                                <div class="row" id="previewContainer">
                                    <div class="col-3">
                                        ...
                                        <img id="coverPreview" src="{{ $book->cover_image ? asset('storage/' . $book->cover_image) : asset('https://placehold.co/400x600') }}" alt="Image Preview" class="img-fluid"/>
                                    </div>
                                    <div class="col-9">
...
$(document).ready(function() {
    ...
    const initialCoverImage = $('#coverPreview').attr('src');
    ...
    $('#cancelUploadButton').click(function() {
        ...
        $('#coverPreview').attr('src', initialCoverImage);
